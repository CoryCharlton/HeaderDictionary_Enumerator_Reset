...
public class FixedHeaderDictionary : IHeaderDictionary
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="FixedHeaderDictionary"/>.
    /// </summary>
    public FixedHeaderDictionary()
    {
    }
    ...
    public FixedHeaderDictionary(Dictionary<string, StringValues>? store)
    {
        Store = store;
    }
    ...
    public FixedHeaderDictionary(int capacity)
    {
    ...
    /// <summary>
    /// Gets the number of elements contained in the <see cref="FixedHeaderDictionary" />;.
    /// </summary>
    /// <returns>The number of elements contained in the <see cref="FixedHeaderDictionary" />.</returns>
    public int Count => Store?.Count ?? 0;

    /// <summary>
    /// Gets a value that indicates whether the <see cref="FixedHeaderDictionary" /> is in read-only mode.
    /// </summary>
    /// <returns>true if the <see cref="FixedHeaderDictionary" /> is in read-only mode; otherwise, false.</returns>
    ...
    /// <summary>
    /// Determines whether the <see cref="FixedHeaderDictionary" /> contains a specific key.
    /// </summary>
    /// <param name="key">The key.</param>
    /// <returns>true if the <see cref="FixedHeaderDictionary" /> contains a specific key; otherwise, false.</returns>
    ...
    /// <summary>
    /// Copies the <see cref="FixedHeaderDictionary" /> elements to a one-dimensional Array instance at the specified index.
    /// </summary>
    /// <param name="array">The one-dimensional Array that is the destination of the specified objects copied from the <see cref="FixedHeaderDictionary" />.</param>
    ...
    /// <returns>true if the <see cref="FixedHeaderDictionary" /> contains the key; otherwise, false.</returns>
    ...
    /// <summary>
    /// Enumerates a <see cref="FixedHeaderDictionary"/>.
    /// </summary>
    public struct Enumerator : IEnumerator<KeyValuePair<string, StringValues>>
    {
        ...
        /// <summary>
        /// Advances the enumerator to the next element of the <see cref="FixedHeaderDictionary"/>.
        /// </summary>
